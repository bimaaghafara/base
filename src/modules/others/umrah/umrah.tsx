...
const ImageHeader: React.FC<any> = () => (
	<div className="image-header-wrapper">
		...
		<div className="description">
			<Typography.Title level={3} className="text">Donators: help our muslim brothers and sisters to go to Mecca</Typography.Title>
			<Button type="primary">Sponsor an umroh</Button>
		</div>
	</div>
);
...
const ImageHeaderDetail: React.FC<any> = () => (
	<div>
		<Typography.Title level={4}>Win a FREE umrah from our sponsors! No strings attached!</Typography.Title>
		<Button type="primary">Win a free umrah</Button>
	</div>
)
...
const TopCards: React.FC<any> = (props) => {
			...
			<div className="top-card-wrapper">
				<div className="top-section">
					<div className="shadow">
						<div className="title">Mecca+Madina+Jerusalem</div>
						<div className="description">
							<div><Icon type="calendar"/> Period: May 2020</div>
							<div><Icon type="idcard"/> Prize: 2 Tickets</div>
							<div><Icon type="user"/> Sponsor: Maksum Tours</div>
	...
	return (
		<div className="top-cards-wrapper">
			<Typography.Title level={4} className="title">Upcoming Umrah</Typography.Title>
			<Row gutter={[16, 16]}>
...
class Umrah extends React.Component<any, any> {
