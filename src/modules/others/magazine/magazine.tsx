...
const ImageHeader: React.FC<any> = () => (
	<div className="image-header-wrapper">
		...
		<div className="description">
			<Typography.Title level={3} className="text">Subscribe to our magazine issues for lates news in muslim community network</Typography.Title>
			<Button type="primary">Get your copy TODAY</Button>
		</div>
	</div>
);
...
const ImageHeaderDetail: React.FC<any> = () => (
	<div>
		<Typography.Title level={4}>Do you want to connect your business with THOUSANDS of our community members?</Typography.Title>
		<Button type="primary">Register your business into our Advertising Network</Button>
	</div>
)
...
const TopCards: React.FC<any> = (props) => {
			...
			<div className="top-card-wrapper">
				<div className="top-section">
					<div className="shadow">
						<div className="title">MCN Magazine Digital Issue #1</div>
						<div className="description">
							<div><Icon type="calendar"/> Published: Feb 2020</div>
							<div><Icon type="idcard"/> Price: Free</div>
							<div><Icon type="user"/> Published by: MCN News Network</div>
	...
	return (
		<div className="top-cards-wrapper">
			<Typography.Title level={4} className="title">Our previous digital issues</Typography.Title>
			<Row gutter={[16, 16]}>
